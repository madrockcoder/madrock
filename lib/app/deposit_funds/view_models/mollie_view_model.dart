...
import 'package:geniuspay/app/deposit_funds/pages/mollie/mollie_confirm_page.dart';
...
@lazySingleton
class MollieViewModel extends BaseModel {
  ...
  Future<void> initiatePayment(BuildContext context, String paymentUrl,
      String amount, Wallet wallet, String mollieId) async {
    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) => PaymentWebViewTemplate(
                url: paymentUrl,
                completedUrl: '$baseUrl/events/mollie',
              )),
    );
    final result = await _depositFundsService.molliePaymentStatus(mollieId);
  ...
  Future<void> createMolliePayment(
    ...
    result.fold((l) {
      ...
      MollieConfirmDepositPage.show(context, wallet, r);
    });
  }
}
